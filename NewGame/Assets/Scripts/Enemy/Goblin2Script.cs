...
public class Goblin2Script : MonoBehaviour
{
    ...
    public void setStats(int level)
    {
        ...
        lvlText.text = "Goblin Lvl " + currLevel.ToString();
    }
    ...
    IEnumerator Attack()
    {
        ...
        player.GetComponent<PlayerController>().CallStunned(stunChance, stunDuration); //Stun chance
    ...
    {
        Vector3 offset = new Vector3(2.9f, 1.0f, 0.0f);
